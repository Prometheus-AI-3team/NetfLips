...
def cli_main(
    ...
    if args.profile:
        ...
        print("TB logdir =", cfg.common.tensorboard_logdir) # TB logdir = ./utut_ckpt/unit_mbart_multilingual_ft/en_ko                                                                                                           
        print("log_format =", cfg.common.log_format)        # log_format = json
